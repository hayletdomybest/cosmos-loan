...
var (
	...
	fd_Loan_apy        protoreflect.FieldDescriptor
	fd_Loan_borrowTime protoreflect.FieldDescriptor
...
func init() {
	...
	fd_Loan_apy = md_Loan.Fields().ByName("apy")
	fd_Loan_borrowTime = md_Loan.Fields().ByName("borrowTime")
...
func (x *fastReflection_Loan) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "loan.loan.Loan.collateral":
		return x.Collateral != ""
	case "loan.loan.Loan.apy":
		return x.Apy != ""
	case "loan.loan.Loan.borrowTime":
...
func (x *fastReflection_Loan) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "loan.loan.Loan.apy":
		panic(fmt.Errorf("field apy of message loan.loan.Loan is not mutable"))
	case "loan.loan.Loan.borrowTime":
		panic(fmt.Errorf("field borrowTime of message loan.loan.Loan is not mutable"))
	case "loan.loan.Loan.state":
...
func (x *Loan) GetBorrowTime() uint64 {
	if x != nil {
		return x.BorrowTime
	}
	return 0
...
func (x *Loan) GetDeadline() uint64 {
	if x != nil {
		return x.Deadline
	}
	return 0
...
var file_loan_loan_loan_proto_rawDesc = []byte{
	...
	0x6e, 0x22, 0xe6, 0x01, 0x0a, 0x04, 0x4c, 0x6f, 0x61, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	...
	,
